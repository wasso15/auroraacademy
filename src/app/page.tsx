...
//                 <p className="text-lg lg:text-xl xl:text-2xl text-orange-100 max-w-2xl leading-relaxed">
//                   {t("home.heroSubtitle")}
//                 </p>
//               </div>
...
//       {/* Statistics Section - Nouvelle section dédiée */}
...
//               Chaque chiffre raconte une histoire de transformation et
//               d'innovation dans l'éducation numérique.
//             </p>
//           </div>
...
//               Rejoignez notre communauté grandissante d'apprenants et de
//               créateurs !
//             </p>
