        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {achievements.map((achievement, index) => (
              <Card key={index} className="group border-0 shadow-xl hover:shadow-2xl text-center transition-all duration-500 hover:scale-110 bg-white/80 backdrop-blur-sm overflow-hidden relative">
                {/* Image de fond */}
                ...
                <CardContent className="pt-8 pb-8 relative z-10">
                  ...
                  <div className="mt-4 h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div 
                      className="h-full bg-gradient-to-r from-[#ff7100] to-[#ff9100] rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform duration-1000 origin-left"
                    ></div>
                  </div>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="group border-0 shadow-xl hover:shadow-2xl transition-all duration-500 bg-white/80 backdrop-blur-sm hover:scale-105 overflow-hidden relative">
                {/* Gradient background */}
                ...
                <CardHeader className="text-center relative z-10 pb-4">
                  <div className="relative mb-6">
                    ...
                    >
                      <feature.icon className="h-10 w-10 group-hover:animate-pulse" style={{ color: feature.color }} />
                    </div>
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="group border-0 shadow-xl hover:shadow-2xl transition-all duration-500 bg-white/80 backdrop-blur-sm hover:scale-105 relative overflow-hidden">
                ...
                <CardContent className="pt-8 relative z-10">
                  ...
                  <div className="flex items-center justify-center gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-[#ff7100] font-medium">{testimonial.role}</div>
                    </div>
                  </div>
                  
                  {/* Highlight tag */}
                  <div className="mt-4 text-center">
                    <Badge variant="secondary" className="bg-gradient-to-r from-orange-100 to-red-100 text-[#ff7100] border-0">
